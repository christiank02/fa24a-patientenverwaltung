...
public class PatientIDaoFile extends AbstractIDaoFile<Patient, Long> {

    public PatientIDaoFile(FilePersistenceService<Patient> filePersistenceService, Path filePath) {
